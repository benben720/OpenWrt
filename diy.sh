...
sed -i 's/192.168.1.1/10.0.0.1/g' package/base-files/files/lib/functions/uci-defaults.sh
...
sed -i "s/${orig_version}/R${date_version} by GaoFang/g" package/lean/default-settings/files/zzz-default-settings
